...
<div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><strong>Nguyên liệu</strong></div>
                            <div class="card-body card-block">
                                <form class="form-horizontal form-label-left input_mask" action="XL_themnl.php" method="POST"enctype="multipart/form-data" accept-charset="utf-8">
                                <div class="form-group"><label class=" form-control-label">Tên nguyên liệu</label><input type="text" name="nl_ten" placeholder="Nhập tên nguyên liệu" class="form-control"></div>
                                <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Nhóm</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="loainl_id" class="form-control" required="" />
                                              <option value="">Chọn nhóm nguyên liệu</option>
                                              <?php
                                                include('connect.php');
                                                $sql = "SELECT loainl_id, loainl_ten FROM loai_nguyen_lieu";
                                                $result = mysqli_query($con,$sql);
                                                while ($row = mysqli_fetch_array($result)) {
                                                  echo "<option value='".$row['loainl_id']."'>".$row['loainl_ten']."</option>";
                                                }
                                            ?>
                                            </select>
                                        </div>
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="dvt_id" class="form-control" required="" />
                                              ...
                                              <?php
                                                ...
                                                $result = mysqli_query($con,$sql);
                                                while ($row = mysqli_fetch_array($result)) {
                                                  echo "<option value='".$row['dvt_id']."'>".$row['dvt_ten']."</option>";
                                                }
                                            ?>
                                            </select> 
                                        </div>
