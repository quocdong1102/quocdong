...
<div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label class=" form-control-label">Tên loại dinhs dưỡng</label><input type="text" class="form-control" name="loaidd_ten" required="required" placeholder="Nhập tên loại dinh dưỡng"></div>
