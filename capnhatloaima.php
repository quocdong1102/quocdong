...
<div class="col-lg-6">
                                    ...
                                    $sql = "SELECT * FROM loai_mon_an where loai_mon_an.loaima_id='$id' ";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form class="form-horizontal form-label-left input_mask" action="XL_capnhatloaima.php" method="POST"enctype="multipart/form-data" accept-charset="utf-8">
                                    <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>">
                                <div class="form-group"><label class=" form-control-label">Tên loại món ăn</label><input type="text" name="loaima_ten" placeholder="Nhập tên loại" class="form-control" value="<?php echo $row['loaima_ten'];  ?>" require=""></div>
                                
                                <div class="form-group"><label class=" form-control-label">Ghi chú</label><input type="text" name="loaima_ghichu" placeholder="Nhập ghi chú" class="form-control" value="<?php echo $row['loaima_ghichu'];  ?>" require=""></div>
