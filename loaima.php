                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Loại món ăn</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><strong>Loại món ăn</strong></div>
                            <div class="card-body card-block">
                                <form class="form-horizontal form-label-left input_mask" action="XL_themloaima.php" method="POST"enctype="multipart/form-data" accept-charset="utf-8">
                                <div class="form-group"><label class=" form-control-label">Tên loại món ăn</label><input type="text" name="loaima_ten" placeholder="Nhập tên loại" class="form-control"></div>
                                
                                <div class="form-group"><label class=" form-control-label">Ghi chú</label><input type="text" name="loaima_ghichu" placeholder="Nhập ghi chú" class="form-control"></div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Danh sách loại món ăn</strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <?php
                                            ...
                                            require('connect.php');
                                             ...
                                             if ($tranghientai > $sotrang)
                                             {
                                               ...
                                               if($tongsotin > 0){
                                               $result = mysqli_query($con, "SELECT * FROM loai_mon_an");
                                        ...
                                        <tbody>
                                            ...
                                            <?php   $number = $stt++ ?>
                                                ...
                                                <td style="width: 190px;"><?php echo $row['loaima_ten']; ?></td>
                                                <td><?php echo $row['loaima_ghichu'];?></td>
                                                
                                                <td class=" last" style="width: 120px;">
                                                <!-- xu ly button  -->
                                                    <span style="font-size: 12px"><?php echo "<a href='capnhatloaima.php?id=".$row['loaima_id']."'>Cập nhật</a>|"?></span>
                                                    <span style="font-size: 12px"><?php echo "<a href='xoaloaima.php?id=".$row['loaima_id']."'>Xóa</a>"?></span>
