                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Loại nguyên liệu</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form class="form-horizontal form-label-left input_mask" action="XL_themloainl.php" method="POST"enctype="multipart/form-data" accept-charset="utf-8">
                                <div class="form-group"><label class=" form-control-label">Tên loại nguyên liệu</label><input type="text" name="loainl_ten" placeholder="Nhập tên loại" class="form-control"></div>
                                
                                <div class="form-group"><label class=" form-control-label">Ghi chú</label><input type="text" name="loainl_ghichu" placeholder="Nhập ghi chú" class="form-control"></div>
                                
                                
                               
                                <div class="form-actions form-group"><button type="submit" name="submit" class="btn btn-primary btn-sm">Lưu</button> <button type="submit" class="btn btn-sm btn-danger">Hủy</button></div> 
                                </form>
                            </div>
                        </div>
...
<div class="content">
                                    ...
                                    $stt=1;
                                    include('connect.php');
                                    $sql = "SELECT * FROM loai_nguyen_lieu ";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Danh sách loại nguyên liệu</strong>
                            </div>
                            <div class="card-body">
                                     ...
                                     <?php
                                            ...
                                            require('connect.php');
                                             ...
                                             if ($tranghientai > $sotrang)
                                             {
                                               ...
                                               if($tongsotin > 0){
                                               $result = mysqli_query($con, "SELECT * FROM loai_nguyen_lieu");
                                        ...
                                        <tbody>
                                            ...
                                            <?php   $number = $stt++ ?>
                                                ...
                                                <td style="width: 190px;"><?php echo $row['loainl_ten']; ?></td>
                                                <td><?php echo $row['loainl_ghichu'];?></td>
                                                
                                                <td class=" last" style="width: 120px;">
                                                <!-- xu ly button  -->
                                                    <span style="font-size: 12px"><?php echo "<a href='capnhatloainl.php?id=".$row['loainl_id']."'>Cập nhật</a>|"?></span>
                                                    <span style="font-size: 12px"><?php echo "<a href='xoaloainl.php?id=".$row['loainl_id']."'>Xóa</a>"?></span>
