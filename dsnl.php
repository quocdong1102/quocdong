                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Nguyên liệu</strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        <tbody>
                                            ...
                                            <?php   $number = $stt++ ?>
                                                ...
                                                <td><?php echo $row['nl_ten']; ?></td>
                                                <td><?php echo $row['loainl_ten'];?></td>
                                               
                                                
                                                <td class=" last" style="width: 160px;">
                                                <!-- xu ly button  -->
                                                    <span style="font-size: 12px"><?php echo "<a href='#'>Cập nhật</a>|"?></span>
                                                    <span style="font-size: 12px"><?php echo "<a href='chitietnl.php?nl_id=".$row['nl_id']."'>Chi tiết</a>|"?></span>
                                                    <span style="font-size: 12px"><?php echo "<a href='xoanl.php?id=".$row['nl_id']."'>Xóa</a>"?></span>
