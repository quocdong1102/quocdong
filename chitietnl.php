    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div id="noidung" style="width:100%; height: auto; "> 
                <h4 style="margin-top:10px;  margin-left:60px; font-weight: bold; font-size:26px;"> <?php echo $row['nl_ten'];?> </h4>
                <!-- <br/> -->
                <hr>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="col-md-4 col-sm-8 pull-left">
                                ...
                                <ul class="info" style="margin-left:30px; font-size:17px;">
                                    ...
                                    <a href="dsnl.php"><i class="fa fa-arrow-left pull-right"> Trở về trang trước</i></a>
                                </ul>
